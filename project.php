      ...
      ?>
                ...
                <div class="panel panel-default">
                     ...
                     <div class="panel-body">
                       <div class="row">
                          <div class="col-md-12">
                         <a href=projectAdd.php><span class="glyphicon glyphicon-plus" aria-hidden="true" ></span> Add Project</a>
   ...
   <?php
    ...
    ?>
      <tr>
        ...
        <td><a class="btn btn-default" href="details.php?details=<?= $row['projectID']; ?>">View</a><a href="addemp.php?delete=<?= $row['projectID']; ?>" class="btn btn-danger" onclick="return confirm('Do you want to delete this record?')">Delete</a></td>
