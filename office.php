  ...
  <body>
    ...
    <header id="header">
     <div class="container">
       <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-usd" aria-hidden="true" ></span> Accounts<small> Manage your Office Accounts</small></h1>
   ...
   <section id="breadcrumb">
      ...
      <ol class="breadcrumb">
        ...
        <li>Finances</li>
        <li class="active">Office Accounts</li>
      </ol>
          ...
          <div class="row">
              ...
              <ul>
                   ...
                   <li><a href="client.php"><span class="glyphicon glyphicon-user" aria-hidden="true" ></span><b> Clients</b></a></li>
                    ...
                    <li> <a href="#" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-usd" aria-hidden="true" ></span> Finances        <span class="glyphicon glyphicon-chevron-right" aria-hidden="true" ></span></a>
                         <ul>
           ...
           <div class="col-md-9">
                ...
                <div class="panel panel-default">
                     <div class="panel-heading  main-color-bg">
                            <h3 class="panel-title">Office Accounts</h3>
                      </div>
