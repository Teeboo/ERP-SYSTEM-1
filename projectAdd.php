...
<html lang="en">
  ...
  <body>
    ...
    <header id="header">
     <div class="container">
       <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-cog" aria-hidden="true" ></span>Projects <small>Manage your projects</small></h1>
  ...
  <section id="main">
      <div class="container">
        ...
        <button type="submit" name="submit" class="btn btn-warning"><span class="glyphicon glyphicon-plus" aria-hidden="true" ></span>Add Project</button>
