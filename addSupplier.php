...
<html lang="en">
  ...
  <section id="main">
      <div class="container">
           ...
           <div class="col-md-9">
                ...
                <div class="panel panel-default">
                     ...
                     <div class="panel-body">
                         ...
                         <br>
                      <form action="Suppaction.php" method="POST" id="insert_form">
        ...
        <input type ="text" name="SupplierMobile" class="form-control" placeholder="Enter Supplier Contact" required>
          
        </div>
        <div class="form-group">
        <label>Supplier Email</label>
        <input type="text" name="SupplierEmail" class="form-control" placeholder="Enter Supplier Email" required>
          
        </div>
        <div class="form-group">
        <label>Address:</label>
        <input type="text" name="SupplierAddress" class="form-control" placeholder="Address" required>
       
        
      </div>
    <div class="form-group">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="submit" name="add" class="btn btn-warning"><span class="glyphicon glyphicon-plus" aria-hidden="true" ></span>Add Supplier</button>
      </div>
