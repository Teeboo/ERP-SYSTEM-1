      ...
      ?>
                <div class="panel panel-default">
                     ...
                     <div class="panel-body">
                       <div class="row">
                          <div class="col-md-12">
                          <a href=addSupplier.php><span class="glyphicon glyphicon-plus" aria-hidden="true" ></span> Add Supplier</a>
   ...
   <?php
    ...
    ?>
      <tr>
        ...
        <td><?= $row['SupplierMobile']; ?></td>
        <td><?= $row['SupplierEmail']; ?></td>
        <td><?= $row['SupplierAddress']; ?></td>
        

        <td><a class="btn btn-default" href="viewSupp.php?view=<?= $row['id']; ?>">View</a><a href="addemp.php?delete=<?= $row['id']; ?>" class="btn btn-danger" onclick="return confirm('Do you want to delete this record?')">Delete</a></td>
