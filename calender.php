  ...
  <body>
    ...
    <header id="header">
     <div class="container">
       <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-calendar" aria-hidden="true" ></span>Calendar<small> Manage your calendar</small></h1>
      ...
      <div class="container">
          <div class="row">
              ...
              <ul>
                   ...
                   <li> <a href="#" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-calendar" aria-hidden="true" ></span> Calender</a></li>
