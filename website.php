...
<html lang="en">
  ...
  <body>
    ...
    <header id="header">
     <div class="container">
       <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-globe" aria-hidden="true" ></span> Website  <small>Manage your Website</small></h1>
  ...
  <section id="main">
          ...
          <div class="row">
              ...
              <ul>
                   ...
                   <li><a href="bank.php"><span class=" glyphicon glyphicon-briefcase" aria-hidden="true" ></span><b> Bank Management</b></a></li>
                     <li><a href="transition.php"><span class="glyphicon glyphicon-credit-card" aria-hidden="true" ></span><b> Transactions</b></a></li>
                   ...
                   <li><a href="Supply.php"><span class="glyphicon glyphicon-briefcase" aria-hidden="true" ></span><b> Manage Suppliers</b></a></li>
                    ...
                    <li> <a href="#" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-cog" aria-hidden="true" ></span> General Settings <span class="glyphicon glyphicon-chevron-right" aria-hidden="true" ></span></a>
                     <ul>
           ...
           <div class="col-md-9">
                ...
                <div class="panel panel-default">
                     <div class="panel-heading  main-color-bg">
                            <h3 class="panel-title">Website Management</h3>
                      </div>
                     <div class="panel-body">
                       <div class="row">
                          <div class="col-md-12">
                          <form action="addweb.php" method="POST" id="insert_form">
 
      
      
        <div class="form-group">
        <label>website Name:</label>
        <input type="text" name="website" class="form-control" placeholder="website name" required>
          
        </div>
        <div class="form-group">
        <label>Web Contact Info:</label>
      ...
      <div class="form-group">
        <label>Web header1:</label>
        <input type ="text" name="h5" class="form-control" placeholder="Enter header5" >
          
        </div>
        <div class="form-group">
        <label>Web header2:</label>
        <input type="text" name="h3" class="form-control" placeholder="Enter header2" >
          
        </div>
        <div class="form-group">
        <label>welcome info:</label>
        <input type="text" name="paragraph1" class="form-control" placeholder="Enter company intro" required>
       
        
      </div>
    <div class="form-group">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="submit" name="add" class="btn btn-warning"><span class="glyphicon glyphicon-plus" aria-hidden="true" ></span>Add Website Info</button>
      </div>
