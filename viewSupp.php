  ...
  <body>
    ...
    <header id="header">
     <div class="container">
       <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true" ></span>Suppliers <small>Manage your suppliers</small></h1>
      ...
      <div class="container">
          <div class="row">
              ...
              <ul>
                   ...
                   <li> <a href="#" class="list-group-item"><span class="glyphicon glyphicon-list-alt" aria-hidden="true" ></span> Project Management <span class="glyphicon glyphicon-chevron-right" aria-hidden="true" ></span></a>
                   <ul>
                   ...
                   <li><a href="bank.php"><span class=" glyphicon glyphicon-briefcase" aria-hidden="true" ></span><b> Bank Management</b></a></li>
                    ...
                    <li> <a href="#" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true" ></span> Supply Chain <span class="glyphicon glyphicon-chevron-right" aria-hidden="true" ></span></a>
                         <ul>
                     ...
                     <div class="panel-body">
                       <div class="row">
                          <div class="col-md-12"> 
                              ...
                              <h2><b>Supplier ID:</b> <?= $id; ?></h2>
                              <h3><b>Supplier Name: </b><?= $SupplierName; ?></h3>
                               <h3><b>Supplier Contact:</b> <?= $SupplierMobile; ?></h3>
                                <h3><b>Supplier Email:</b><?= $SupplierEmail; ?></h3>
                                 <h3><b>Supplier Address:</b> <?= $SupplierAddress; ?></h3>

                                 <br>
                                  <button type="button" class="btn btn-warning" data-dismiss="modal"> <span class="glyphicon glyphicon-circle-arrow-left" aria-hidden="true" ></span> Close</button>
...
<footer id="footer">
  ...
  <form action="addproject.php" method="POST" id="insert_form">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type ="text" name="manager" class="form-control" placeholder="Project Manager" required>
        ...
        <input type="text" name="site" class="form-control" placeholder="Project Site" required>
        ...
        <textarea type="text" name="editor1" class="form-control" placeholder="Enter project description" required=""></textarea>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="submit" class="btn btn-primary"><span class="glyphicon glyphicon-plus" aria-hidden="true" ></span>Add Project</button>
      </div>
      </div>
      </form>
    </div>
