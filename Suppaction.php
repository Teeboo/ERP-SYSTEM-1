<?php
	...
	if(isset($_POST['add']))
	{
		...
		$query="INSERT INTO suppliers(SupplierName,SupplierMobile,SupplierEmail,SupplierAddress)VALUES(?,?,?,?)";
		$stmt=$db->prepare($query);
		$stmt->bind_param("ssss",$SupplierName,$SupplierMobile,$SupplierEmail,$SupplierAddress);
		$stmt->execute();
