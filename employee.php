      ...
      ?>
                ...
                <div class="panel panel-default">
                     ...
                     <div class="panel-body">
                       <div class="row">
                          <div class="col-md-12">
                          <a href=addemp.php><span class="glyphicon glyphicon-plus" aria-hidden="true" ></span> Add Employee</a>
   ...
   <?php
    ...
    ?>
      <tr>
        ...
        <td><a class="btn btn-default" href="details.php?details=<?= $row['empID']; ?>">View</a><a href="addemp.php?delete=<?= $row['empID']; ?>" class="btn btn-danger" onclick="return confirm('Do you want to delete this record?')">Delete</a></td>
